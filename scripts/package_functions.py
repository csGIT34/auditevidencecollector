...
def package(output):
    ...
    modules = ('__init__', '__main__', 'archive', 'assessment', 'authorization', 'backup_population', 'azure_adapters', 'catalog', 'cli', 'collector', 'compute_instances', 'controls', 'diagnostic_routes', 'graph',
